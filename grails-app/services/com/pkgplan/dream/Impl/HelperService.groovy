...
class HelperService extends WebTierService{
     ...
     */
    static String getUserAgentString(def request) {
    ...
    static Result executeRemoteScript(String server, String username, String password, String script) {
        SSHExec ssh = null;
        try {
            ConnBean cb = new ConnBean(server, username, password);
            ssh = SSHExec.getInstance(cb);
            //CustomTask echo = new ExecCommand('last \\| grep ppp');
