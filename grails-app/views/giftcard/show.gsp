...
<html>
	...
	<body>
		<a href="#show-giftcard" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-giftcard" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${giftcardInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
