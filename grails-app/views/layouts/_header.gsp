...
<header>
    <div class="inner">
        ...
        <div class="lang-select">
            <ul class="">
                <li class="lang-comp <g:if test="${locale.toString().equals('en') || !locale.toString()}">lang-selected</g:if>"><span><g:link absolute="${request.forwardURI}" params="[lang:'en']">English</g:link></span></li>
