...
<link rel="stylesheet" href="${resource(dir:'css',file:'main.css')}?${grailsApplication.config.dream.timestamp}" />
<link rel="shortcut icon" href="${resource(dir:'images',file:'favicon.ico')}" type="image/x-icon" />
<link href='https://fonts.googleapis.com/css?family=Architects+Daughter' rel='stylesheet' type='text/css'>
<link rel="stylesheet" type="text/css" href="${resource(dir:'css',file:'stylesheet.css')}?${grailsApplication.config.dream.timestamp}" media="screen" />
